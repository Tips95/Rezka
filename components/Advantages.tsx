...
const stats = [
  { value: "13 лет", label: "опыт производства", sub: "Работаем с 2012 года", grad: "from-blue-500 to-blue-600", bg: "bg-blue-50/70 backdrop-blur-sm border border-white/60" },
  { value: "500+", label: "проектов", sub: "Москва, Крым, Краснодар", grad: "from-violet-500 to-violet-600", bg: "bg-violet-50/70 backdrop-blur-sm border border-white/60" },
  { value: "5 лет", label: "гарантия", sub: "Официально по договору", grad: "from-emerald-500 to-emerald-600", bg: "bg-emerald-50/70 backdrop-blur-sm border border-white/60" },
  { value: "14 дней", label: "срок реализации", sub: "Под ключ с монтажом", grad: "from-amber-500 to-orange-500", bg: "bg-amber-50/70 backdrop-blur-sm border border-white/60" },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {advantages.map((adv) => {
            ...
            return (
              <div
                key={adv.title}
                className={`border rounded-2xl p-7 bg-white/70 backdrop-blur-sm hover:bg-white/80 hover:shadow-md transition-all ${adv.border}`}
              >
